    ...
    <div class="container d-flex justify-content-center align-items-center p-0">
        <div class="card shadow-lg border-0 auth-card" style="background: #ffffff; border-radius: 20px; width: 100%; max-width: 450px; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.08);">
            ...
            <div class="text-center branding-header">
                ...
                <p style="color: #64748b; font-size: 0.9rem;" class="brand-subtitle">Create an Administrator Account</p>
            </div>

            <form method="POST" action="{{ route('register') }}">
                @csrf 

                <div class="form-group" style="display: flex; flex-direction: column; margin-bottom: 16px;">
                    <label for="name" style="font-size: 0.8rem; font-weight: 600; color: #475569; margin-bottom: 6px; letter-spacing: 0.05em; text-transform: uppercase;">Full Name</label>
                    <input type="text" 
                           name="name" 
                           id="name"
                           value="{{ old('name') }}" 
                ...
                <div class="form-group" style="display: flex; flex-direction: column; margin-bottom: 24px;">
                    <label for="password_confirmation" style="font-size: 0.8rem; font-weight: 600; color: #475569; margin-bottom: 6px; letter-spacing: 0.05em; text-transform: uppercase;">Confirm Password</label>
                    <input type="password" 
                ...
                <div class="text-center footer-navigation" style="text-align: center; margin-top: 24px;">
                    <span style="color: #64748b; font-size: 0.85rem; font-weight: 500;">Already have an account? </span>
                    <a href="{{ route('login') }}" style="color: #4f46e5; font-size: 0.85rem; font-weight: 600; text-decoration: none; transition: color 0.2s ease;">Log in</a>
                </div>
            </form>
